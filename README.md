...
| | |
| --- | --- |
| **Releases GitHub** | [**Dernière version**](https://github.com/cheikh-dev99/voliere-manager/releases/latest) — fichier **`.apk`** (Android) en pièce jointe, **sans** binaire versionné à la racine du dépôt. *(Un IPA iOS peut être ajouté manuellement si besoin.)* |
...
| [Releases mobiles](docs/RELEASES-MOBILES.md) | APK Android via **GitHub Releases** et EAS Build (pas de binaire à la racine). |
