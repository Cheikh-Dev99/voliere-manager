      ...
      <header className="app-header-no-print relative sticky top-0 z-40 border-b border-slate-200/90 bg-white/95 shadow-[0_1px_0_rgba(15,23,42,0.04)] backdrop-blur-md supports-[backdrop-filter]:bg-white/80">
        <div className="mx-auto flex w-full max-w-7xl items-center justify-between gap-2 px-2 py-2.5 sm:px-4 sm:py-3 md:justify-start md:gap-3">
          ...
          <div className="hidden min-w-0 flex-1 md:flex md:justify-end">
            <nav
              className="inline-flex max-w-full flex-nowrap items-center gap-1 overflow-x-auto rounded-2xl border border-slate-200/90 bg-gradient-to-b from-white to-slate-50/95 p-1 shadow-sm ring-1 ring-slate-900/[0.04]"
          ...
          <div className="hidden h-7 w-px shrink-0 self-center bg-slate-200 md:block" aria-hidden />
